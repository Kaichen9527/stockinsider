...
## Purpose
Enable secure LINE account binding and real notification delivery so users receive timely strategy events and digest messages based on personal preferences.
