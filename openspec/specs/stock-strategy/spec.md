# stock-strategy Specification

## Purpose
Translate normalized signals into explicit recommendation and strategy records that can be evaluated, tracked, and surfaced through alert channels.
