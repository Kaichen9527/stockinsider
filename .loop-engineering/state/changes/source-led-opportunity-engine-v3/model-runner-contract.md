...
The sole pin oracle is tracked `model-runner-host-pins-v3.json`. Its pre-LF bytes must be RFC-8785 canonical JSON of exactly 2,132 bytes with SHA-256 `25e485f32668470f002dedc89425ddb5370dacf1a8a22a8ed0ac3fd3602c7f02`; its LF-terminated file is 2,133 bytes. It is part of the active normative graph. Implementation cannot learn expected values from the executable under test.
