...
- Final reviewed repair/tree: `646ee2efdb6b25c5d9cf4afd736d1a4111477653` / `3cf71d30c142ba11b693050fab1dfa68072758ec`
- Full final range: `c17b0e00eb32892a2b557189cdf525ef8a23a388..646ee2efdb6b25c5d9cf4afd736d1a4111477653`
- Active graph: `bb471ec34f836d62ddb2da06883f58ec2dff1e617a63887b5a35e5a621d3ccbb`

## Review result

- Reviewed the complete final branch range after merging the protected `main`. The range contains the portable Contabo data plane plus the canonical v3.17 acceptance reconciliation; no unrelated production mutation is hidden in the merge.
...
- The v3.17 JSON mirror, script-value digest and catalog authority tags now match canonical tracked bytes. All temporary transition normalization has been removed and strict mirror equality restored.
- The protected worker registers only active graph `bb471e...` to the two direct-child requirements and architecture evidence refs; candidate bytes cannot select another review source.
