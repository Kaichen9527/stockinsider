...
- Initial V3.19 candidate commit/tree: `36bf020c9b4fd3940e74365d10a0c2cf0afd4f14` / `42856d9840af50c6245170d36efeddd8b464bc6c`
- Source-cursor repair commit/tree: `a67bc72c0fb11cc97340216a88e55dbf8be7ea7c` / `e6e6726abbcc77b4bfd1403140f29812fff41e1a`
- Final reviewed repair/tree: `c0064e35022c24e4c3a625e3a360c95d82c18470` / `4ccbcb0728b61d291d837ae1e28f6d99ed2cbd10`
- Full final range: `0fe9e359bbf518c01c2dda7b5e54fc00cdc5cafa..c0064e35022c24e4c3a625e3a360c95d82c18470`
- Active graph: `cfc135973718c924114f367953fac9e38cc48918df54832efa27205fc997622a`

## Review closure

The first exact inspection found one product P1 class: a timestamp-only source
cursor could skip a revision when two valid source revisions shared the same
`recorded_at`. The repair persists and compares the lexicographic
`(recorded_at, revision_id)` pair and its V3.19 regression covers the tie.

Protected CI then found a second P1 in review evidence grammar: its closed
declarators split a commit/tree and reviewed range across physical lines,
which the base-owned parser correctly rejects. The Requirements, Architecture
and exact declarators are now each single-line, unambiguous claims. Their
direct-child chain has been recreated without changing the reviewed active
