# V3.14 protected Architecture compatibility evidence

Date: 2026-08-11
Review authority: fresh Architecture Round 18, carried at the protected worker's
...
Official financial, valuation, adjusted-price and calendar authority remains
point-in-time and append-only. Missing authority produces typed unavailable or
read-only output, never a fabricated target or buy action. A single invalid source
card cannot abort the compact projection, while invalid provenance is excluded from
both cards and public discovery counts.

Web, producer manifest, migration level and projection schema remain one release
identity. The rollout keeps V3 Promotion, LINE, dispatch and automatic trading
disabled. This evidence grants only Architecture eligibility for exact review and
the protected Code Gate; production mutation still requires the separately recorded
V3.14 authority and rollback sequence.
