...
const config = { schema: 'stockinsider-local-backup-run-v2', directory: CONFIRMED_BACKUP_DIRECTORY,
  ...
  pgModule: '/private/node_modules/pg', restoreScratchDirectory: '/private/tmp',
  incomingBytes: 5_000_000_000, temporaryBytes: 5_000_000_000 };
