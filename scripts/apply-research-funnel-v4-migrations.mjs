...
export const RESEARCH_FUNNEL_V4_MIGRATIONS = Object.freeze([
  ...
  // V6 is deliberately appended after the truth boundary.  Its contract
  // migration relies on `fact_kind`, documents rely on that contract, and the
  // article outbox/replay planes rely on their V4 predecessors above.
