...
const MODEL_RUNNER_IDENTITY = [
  ['approvalPolicy', 'never'], ['codexVersion', '0.149.0-alpha.4'], ['contractVersion', 'model-runner-v3.6'],
  ['gitVersion', '2.50.1 (Apple Git-155)'], ['hardIsolationClaims', ['external_user_read', 'authoritative_write', 'command_network']],
  ['hostPinFixtureSha256', '86ca1054b4e3e131ee9db618ec7280257cf9d6deeeb677e9a29f113771386264'],
  ['hostPinVersion', 'model-runner-host-pins-v3.11'], ['journalVersion', 'model-runner-journal-v3.5'],
...
const MODEL_RUNNER_IDENTITY_SHA256 = '7c35ae3e001a7a42d5cfd697a46562838af668c49445243a53c18567ad4da482';
