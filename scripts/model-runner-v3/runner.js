...
const MODEL_RUNNER_IDENTITY = [
  ['approvalPolicy', 'never'], ['codexVersion', '0.151.0-alpha.7.2'], ['contractVersion', 'model-runner-v3.6'],
  ['gitVersion', '2.50.1 (Apple Git-155)'], ['hardIsolationClaims', ['external_user_read', 'authoritative_write', 'command_network']],
  ['hostPinFixtureSha256', 'bfa364974e14fb4b326d171be8db9d0ad09b7f9a9d698119d81ac5d553afbe9d'],
  ['hostPinVersion', 'model-runner-host-pins-v3.14'], ['journalVersion', 'model-runner-journal-v3.5'],
...
const MODEL_RUNNER_IDENTITY_SHA256 = '89c5fd414840e577729d55933fd0eef4a4cf8fdaa494feb6895d67ce895331e7';
