#!/usr/bin/env bash
set -euo pipefail
# Run after activating a reviewed release. Only the credential-free parser
...
for parser_file in candidate_financial_parser_socket.py candidate_financial_document_parser.py candidate_financial_fact_scope.py; do
