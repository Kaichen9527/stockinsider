...
const foreignBuyWave = auoMarketContext.institutionalFlow.slice(0, 2).reduce((sum, row) => sum + row.foreignNetShares, 0);
const foreignSellWave = auoMarketContext.institutionalFlow.slice(2).reduce((sum, row) => sum + row.foreignNetShares, 0);
