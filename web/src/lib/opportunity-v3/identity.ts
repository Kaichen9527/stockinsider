...
export const STATIC_IDENTITY_MEMBERS_V3 = [
  ['acceptanceVersion','1.46.0'],['analysisRevisionContractVersion','stock-analysis-revision-v3.11.2'],
  ...
  ['postgresTypeContractVersion','opportunity-postgres-types-v3.22'],['priceProviderAllowlistHash','48fa54ee9f0e3a0b888ac0dc17eda8ad5bb746106a6fe4395eb50a5865e4e44e'],
  ...
  ['storageContractVersion','opportunity-storage-v3.25'],['taxonomyMapHash','6b28d85903d7a410eef29386de011c71aa789dc0ce3231df38cb4e085181060c'],
...
if (COMPARISON_CONTRACT_KEY_V3 !== 'c81d16af92ec44fc2386165cd70f9665662e2052c680f831c78cf7d324020729') throw new Error('comparison identity digest mismatch');
