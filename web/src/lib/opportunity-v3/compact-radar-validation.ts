...
export function validateCompactRadarProjectionRow(
  ...
  const decisionSchema=['legacy-radar-v3.13.0','legacy-radar-v3.14.0','legacy-radar-v3.17.0'].includes(value.sourceLedCorrectness?.schema);
  ...
  if (!['legacy-radar-v3.11.3', 'legacy-radar-v3.12.0', 'legacy-radar-v3.13.0','legacy-radar-v3.14.0','legacy-radar-v3.17.0'].includes(value.sourceLedCorrectness?.schema)
