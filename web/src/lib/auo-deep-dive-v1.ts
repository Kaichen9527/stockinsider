...
export const auoArticleSections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'P/E 在接近損平時非常敏感：EPS 從 0.3 元變成 0.6 元，倍數會直接減半，卻不代表企業價值減半。因此保守情境 EPS 為負或接近零時標示不適用；基本與樂觀情境才用 20 倍與 24 倍檢查成長能否支撐現價。主要估值則從 2026Q2 歸屬普通股權益出發，加入 2026Q3 至 2027Q3 五季各情境的正常化歸屬淨利，明列股利、增資與 OCI 假設，再除以期末普通股數得到 Forward BVPS。歷史錨點由 2021 年 10 月至 2026 年 9 月共 60 個 TWSE 月底觀測即時計算，第 25、50、75 百分位為 0.70、0.77、0.85 倍。P/E 只作交叉檢查，不再以人工權重混入主目標價。',
